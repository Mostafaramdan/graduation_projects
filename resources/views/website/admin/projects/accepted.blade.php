                        ...
                        <div class="d-flex align-items-center shadow-lg p-3 mb-5 bg-body rounded">
                            ...
                            <div class="flex-grow-1 ms-3 " style=" color:#00264d" >
                                ...
                                <div class="d-flex justify-content-center m-5">
                                    <a href="{{route('project.show',$project->id)}}" class="btn btn-block w-25 center-text " style=" background-color:#00264d;color:#fff"> View This Project</a>
                                    <a class="btn btn-light w-25 border border-5 border-primary" href="{{route('project.changeStatus',$project->id)}}?status=finished">Finished</a>
